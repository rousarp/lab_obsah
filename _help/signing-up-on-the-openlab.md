...
1. Once you are sure you can access your City Tech email account, go to the <a href="http://multi.openlab.dev">OpenLab homepage</a> (<a href="https://multi.openlab.dev">https://multi.openlab.dev</a>).  You’ll see <strong>Join OpenLab</strong> on the left of the screen.  Click<strong> Sign Up.</strong>
...
You do not need to go through this process again.  When you want to come back to the OpenLab, simply go to our<a href="http://https://openlab.citytech.cuny.edu"> homepage</a> (<a href="https://multi.openlab.dev">https://openlab.citytech.cuny.edu</a>), and log in with the username and password you created in step two.  You can find more information in the OpenLab help section entitled “<a href="https://multi.openlab.dev/blog/help/logging-in-to-the-openlab/">Logging In To The OpenLab</a>.”

&nbsp;

</div>
<small>This content is created from https://multi.openlab.dev/blog/help/signing-up-on-the-openlab/ with <a href="https://codecanyon.net/item/scrapes-web-scraper-plugin-for-wordpress/18918857?ref=Octolooks">Octolooks Scrapes</a></small>
